// MultiThread8Dlg.cpp : implementation file
//
...
CMultiThread8Dlg::CMultiThread8Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMultiThread8Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMultiThread8Dlg)
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMultiThread8Dlg)
	DDX_Control(pDX, IDC_D, m_ctrlD);
	DDX_Control(pDX, IDC_W, m_ctrlW);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMultiThread8Dlg, CDialog)
	//{{AFX_MSG_MAP(CMultiThread8Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_WRITEW, OnWritew)
	ON_BN_CLICKED(IDC_WRITED, OnWrited)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMultiThread8Dlg message handlers
