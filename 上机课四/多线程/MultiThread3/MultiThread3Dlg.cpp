// MultiThread3Dlg.cpp : implementation file
//
...
CMultiThread3Dlg::CMultiThread3Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMultiThread3Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMultiThread3Dlg)
	m_nMilliSecond = 0;
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMultiThread3Dlg)
	DDX_Control(pDX, IDC_PROGRESS1, m_ctrlProgress);
	DDX_Text(pDX, IDC_MILLISECOND, m_nMilliSecond);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMultiThread3Dlg, CDialog)
	//{{AFX_MSG_MAP(CMultiThread3Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CMultiThread3Dlg message handlers
