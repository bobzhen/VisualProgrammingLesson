// MultiThread9Dlg.cpp : implementation file
//
...
CMultiThread9Dlg::CMultiThread9Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMultiThread9Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMultiThread9Dlg)
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMultiThread9Dlg)
	DDX_Control(pDX, IDC_W, m_ctrlW);
	DDX_Control(pDX, IDC_D, m_ctrlD);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMultiThread9Dlg, CDialog)
	//{{AFX_MSG_MAP(CMultiThread9Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CMultiThread9Dlg message handlers
