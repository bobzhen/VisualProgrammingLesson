...
bool CDXGraph::GetCurrentPosition(LONGLONG * outPosition)
{
	if (mSeeking)
	{
		__int64 position = 0;
...
bool CDXGraph::GetStopPosition(LONGLONG * outPosition)
{
	if (mSeeking)
	{
		__int64 position = 0;
...
bool CDXGraph::SetCurrentPosition(LONGLONG inPosition)
{
	if (mSeeking)
	{
		
		__int64 position = (__int64)(inPosition);
...
bool CDXGraph::SetStartStopPosition(LONGLONG inStart, LONGLONG inStop)
{
	if (mSeeking)
	{
		__int64 startPos = (__int64)( inStart);
		__int64 stopPos  = (__int64)(inStop);
...
bool CDXGraph::GetDuration(LONGLONG * outDuration)
{
	if (mSeeking)
	{
		__int64 length = 0;
